...
char ssid[] = "MyDD2017"; //  your network SSID (name)
char pass[] = "mydd@2017";    // your network password (use for WPA, or use as key for WEP)
int keyIndex = 0;            // your network key Index number (needed only for WEP)

int status = WL_IDLE_STATUS;

char* deviceId = "4b7fd3e682ccc29656fbb76baf6cc2c3"; // Device you want to push to
char* streamName = "pulse"; // Stream you want to push to
char* m2xKey = "5e8464b686c8ecf9fbf889baa9bc952a"; // Your M2X access key
